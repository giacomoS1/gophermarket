...
export const findUserByEmail = async (email) => { // fetches a user from the database by their email
...
export const createUser = async (email, firstName, lastName) => { // adds a user to the database with args
